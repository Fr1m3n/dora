...
slides[10].text = 'Всё таки у тебя день рождения!';
slides[10].type = 'Text';
slides[10].color = 'rgb(51, 204, 105)';
slides[11].text = 'Тебя окружают прекрасные люди.';
slides[11].type = 'Text';
slides[11].color = 'rgb(0, 204, 102)';
slides[12].text = 'И мы всегда готовы тебе помочь.';
slides[12].type = 'Text';
slides[12].color = 'rgb(204, 255, 51)';
slides[13].text = 'Так что никогда не бойся просить (особенно у меня) о чём то.';
slides[13].type = 'Text';
slides[13].color = 'rgb(255, 100, 51)';
slides[14].text = 'Я тебя люблю.';
slides[14].type = 'Text';
slides[14].color = 'rgb(255, 51, 0)';
slides[15].text = '<svg width="640" height="480" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg">'+
 '<g class="lines">'+
  '<title>Layer 1</title>'+
